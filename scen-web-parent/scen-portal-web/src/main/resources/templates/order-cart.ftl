...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/scen-logo.jpg" alt="Scen商城"></a></div>
</div>
...
<#--<c:forEach items="${cartList }" var="cart" varStatus="status">-->
        ...
        <#--<c:set var="totalPrice" value="${ totalPrice + (cart.price * cart.num)}"/>-->
            <#assign totalPrice=totalPrice+cart.price*cart.num>
        ...
        <input type="hidden" name="orderItems[${cart_index}].picPath" value="${cart.image}"/>
        <#--</c:forEach>-->
        </#list>
    <input type="hidden" name="payment"
           value="${totalPrice?c}"/>
    <input type="hidden" name="orderShipping.receiverName" value="任振华"/>
    <input type="hidden" name="orderShipping.receiverMobile" value="15518107074"/>
    ...
    <input type="hidden" name="orderShipping.receiverAddress" value="亦庄 xxxxxxxxx"/>
</form>
                                ...
                                <ul class="ui-switchable-panel-main" id="consignee-list">
                                    ...
                                    <li class="ui-switchable-panel" id="consignee_index_137617472"
                                        ...
                                        <div class="consignee-item item-selected"
                                            ...
                                            <div class="user-name">
                                                <div class="fl">
                                                    <strong limit="4">任振华</strong>&nbsp;&nbsp;收
                                                </div>
                                                <div class="fr">15518107074</div>
                                                <div class="clr"></div>
                                            </div>
                                            <div class="mt10" limit="15">北京 大兴区</div>
                                            <div class="adr-m" limit="30">亦庄 xxxxxxxxx</div>
                                            ...
                                            <div class="goods-suit goods-last">
                                                ...
                                                <#--<c:forEach items="${cartList }" var="cart">-->
                                                    <div class="goods-item goods-item-extra">
                                                        ...
                                                        <div class="p-img">
                                                            <a target="_blank" href="/item/${cart.id?c}.html">
                                                                <img src="${cart.image}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="goods-msg">
                                                            <div class="p-name">
                                                                <a href="/item/${cart.id?c}.html" target="_blank">
                                                                    ${cart.title }
                                                                </a>
                                                            </div>
                                                            <div class="p-price">
                                                                <!--增加预售金额显示 begin   预售分阶段支付类型（1：一阶梯全款支付；2：一阶梯定金支付(全款或定金可选)；3：三阶梯仅定金支付） -->
                                                                <strong>￥${cart.price?string('0.00')}</strong>
                                                                <!--增加预售金额显示 end-->
			...
			个人 &nbsp; </span><span class="mr10"> &nbsp; </span> 明细 <a href="#none"
					...
					<span>
						总商品金额：
                                ...
                                <em class="price" id="warePriceId">¥${totalPrice?string('0.00')}</em>
                            </div>
                            <div class="list">
                    ...
                    <div class="ui-ceilinglamp checkout-buttons">
                        ...
                        <div class="sticky-wrap">
                            <div class="inner">
                                ...
                                <span class="total">应付总额：<strong id="payPriceId">￥${totalPrice?string('0.00')}</strong>
          </span>
